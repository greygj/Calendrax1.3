        ...
        {activeView === 'dashboard' && (
          <div className="space-y-6">
            ...
            {referralInfo?.isCenturion && (
              <button
                onClick={() => setActiveView('centurion')}
                className="w-full border border-amber-500/30 rounded-xl overflow-hidden bg-gradient-to-br from-amber-900/30 via-slate-800/50 to-slate-900/50 p-4 text-left hover:bg-amber-500/10 transition-colors flex items-center gap-4"
              >
                <img 

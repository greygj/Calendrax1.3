      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
                      ...
                      <button
                        ...
                        className={`w-full text-left p-4 rounded-xl border transition-all ${
                          isSelected
                            ...
                            : 'bg-cardBg border-zinc-800 hover:border-zinc-700'
                        }`}
                      >
                    ...
                    <button
                      ...
                      className={`py-2 px-3 rounded-lg text-sm font-medium transition-all ${
                        selectedTime === time
                          ...
                          : 'bg-cardBg border border-zinc-800 text-white hover:border-zinc-700'
                      }`}
                    >
                      {time}
                    </button>
          ...
          <div>
            ...
            {/* Business Info Card */}
            <div className="mt-6 bg-cardBg border border-zinc-800 rounded-xl p-4">

      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-6">
          <div className="text-center py-12">
            <p className="text-gray-400 text-lg">Terms and Conditions content will be added here.</p>
            <p className="text-gray-500 text-sm mt-2">Please check back later for the full terms.</p>
          </div>
        </div>

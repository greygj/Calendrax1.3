        ...
        return (
          <div>
            ...
            <div className="space-y-3">
              {users.map(u => (
                <div key={u.id} className={`bg-zinc-900 border rounded-xl p-4 ${u.suspended ? 'border-red-500/50' : 'border-zinc-800'}`}>
      ...
      case 'businesses':
        return (
          <div>
            ...
            <div className="space-y-3">
              {businesses.map(b => (
                <div key={b.id} className={`bg-zinc-900 border rounded-xl p-4 ${
